  ...
  return (
    ...
    >
      <a target="_blank" href={url}>
        <div className="flex flex-row border-2 border-zm-400 w-full h-full bg-zm-600 rounded ">
          <div className="h-full">
            <img src={image} alt={image} className="rounded" />
          </div>
          <div className="flex flex-col w-full ">
            <div className="px-4 py-2 border-b-2 border-l-2 border-zm-400 w-full">
              <h1 className="text-xl font-bold text-zm-light-100">{title}</h1>
            </div>
            <div className="px-4 py-2 border-l-2 border-zm-400 w-full  leading-3 h-full">
